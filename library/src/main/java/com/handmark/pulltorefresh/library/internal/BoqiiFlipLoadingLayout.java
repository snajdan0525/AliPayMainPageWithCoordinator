...
public class BoqiiFlipLoadingLayout extends LoadingLayout {

	static final int FLIP_ANIMATION_DURATION = 150;

//	private final Animation mRotateAnimation, mResetRotateAnimation;

	public BoqiiFlipLoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
