...
import com.handmark.pulltorefresh.library.internal.BoqiiFlipLoadingLayout;
import com.handmark.pulltorefresh.library.internal.BoqiiFlipslognLoadingLayout;
import com.handmark.pulltorefresh.library.internal.BoqiiRotateLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE: {
			// Log.d("Swipelist", "---onTouchEvent-Move");
			if (mIsBeingDragged) {
				// Log.d("Swipelist", "---onTouchEvent-Move-return");
		...
		case MotionEvent.ACTION_UP: {
			// Log.d("Swipelist", "---onTouchEvent-UP");
			if (mIsBeingDragged) {
				mIsBeingDragged = false;
	...
	protected LoadingLayout createFooterLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		LoadingLayout layout = mLoadingAnimationStyle.createFooterLoadingLayout(context, mode, getPullToRefreshScrollDirection(), attrs);
		layout.setVisibility(View.INVISIBLE);
		return layout;
	}
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createFooterLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			...
			default:
				...
				return new BoqiiFlipslognLoadingLayout(context, mode, scrollDirection, attrs);
			case FLIP:
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			...
			case ROTATE:
			default:
				return new BoqiiRotateLoadingLayout(context, mode, scrollDirection, attrs);
			case FLIP:
				return new BoqiiFlipLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
