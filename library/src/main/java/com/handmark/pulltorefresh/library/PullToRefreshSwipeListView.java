...
public class PullToRefreshSwipeListView extends PullToRefreshAdapterViewBase<SwipeListView>{
	...
	public SwipeListView getListView(){
		return ((SwipeListView)mRefreshableView);
	}
	
	public void SetSelection(int selection){
		((SwipeListView)mRefreshableView).setSelection(selection);
	}
	
	public int pointToPosition(int x, int y){
		return ((SwipeListView)mRefreshableView).pointToPosition(x, y);
	}
	
//	public View getChildAt(int index){
//		return ((ListView)mRefreshableView).getChildAt(index);
//	}

	public int getFirstVisiblePosition(){
		return ((SwipeListView)mRefreshableView).getFirstVisiblePosition();
	}
